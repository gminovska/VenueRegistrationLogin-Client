        ...
        <div>
            <table>
                ...
                <td>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="ZipFieldValidator" runat="server" ErrorMessage="* ZIP Code is required" ControlToValidate="ZipTextBox"></asp:RequiredFieldValidator></td>
                    </tr>
                <tr>
                <td>Phone</td>
                <td>
                    ...
                    <td><asp:RequiredFieldValidator ID="PhoneFieldValidator" runat="server" ErrorMessage="* Phone is required" ControlToValidate="PhoneTextBox"></asp:RequiredFieldValidator></td>
                    </tr>
                <tr>
                <td>Email</td>
                <td>
                ...
                <td>
                    ...
                    <td><asp:RequiredFieldValidator ID="userNameFieldValidator" runat="server" ErrorMessage="* User Name is required" ControlToValidate="VenueUserNameTextBox"></asp:RequiredFieldValidator></td>
                    </tr>
                <tr>
                ...
                <td>
                    ...
                    <td><asp:RequiredFieldValidator ID="passwordFieldValidator" runat="server" ErrorMessage="* Password is required" ControlToValidate="VenuePasswordTextBox"></asp:RequiredFieldValidator></td>
                </tr>
            <tr>
                <td>
